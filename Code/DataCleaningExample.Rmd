...
This is very similar to the original clean dataset except for the fact that there are some `NA` values that we deliberately introduced trying to make this example more generic.
