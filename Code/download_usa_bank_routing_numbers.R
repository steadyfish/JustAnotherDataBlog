...
lnk = rem_dr$findElement(using = "link text", "View the FedACH Directory File Format only")
lnk$getElementText()
lnk$clickElement()
...
rem_dr$goBack()
lnk = rem_dr$findElement(using = "link text", "Receive All FedACH Participant RDFIs with commercial receipt volume")
...
#output
write.csv(d_txt3, "Data/usa_bank_routing_numbers.csv")
write.csv(d_dict, "Data/usa_bank_routing_numbers_data_dictionary.csv")
